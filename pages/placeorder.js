                    ...
                    <div className='grid md:grid-cols-4 md:gap-5'>
                        <div className='overflow-x-auto md:col-span-3'>
                            <div className='card p-5'>
                                ...
                                <div>    <Link href='/shipping' className='link'>Edit</Link></div>
                            </div>
                            ...
                            <div className='card p-5'>
                                ...
                                <div> <Link href='/payment' className='link'>Edit</Link>
                                </div>
                            ...
                            <div className='card overflow-x-auto p-5'>
                                ...
                                <div>
                                    <Link href='/cart' className='link'>Edit</Link>
                                </div>
                            </div>
                        </div>
                        <div>
                                ...
                                <ul>
                                    <li>
                                        <div className='mb-2 flex justify-between'>
                                            <div>Items</div>
                                            <div>{itemsPrice}</div></div>
                                    </li>
                                    <li>
                                        <div className='mb-2 flex justify-between'>
                                            <div>Tax</div>
                                            <div>{taxPrice}</div></div>
                                    </li>
                                    <li>
                                        <div className='mb-2 flex justify-between'>
                                            <div>Shipping</div>
                                            <div>{shippingPrice}</div></div>
                                    </li>
                                    <li>
                                        <div className='mb-2 flex justify-between'>
                                            <div>Total</div>
